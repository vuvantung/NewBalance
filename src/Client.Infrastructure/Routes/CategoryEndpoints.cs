...
namespace NewBalance.Client.Infrastructure.Routes
{
    public class CategoryEndpoints
    {
        ...
        public static string GetCategoryPostOffice ( int pageIndex, int pageSize, int communeCode, int containVXHD ) => $"api/Category/GetCategoryPostOffice?pageIndex={pageIndex}&pageSize={pageSize}&communeCode={communeCode}&containVXHD={containVXHD}";
