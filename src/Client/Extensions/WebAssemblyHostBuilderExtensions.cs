...
using NewBalance.Client.Infrastructure.Authentication;
using NewBalance.Client.Infrastructure.Managers;
...
using NewBalance.Client.Infrastructure.Managers.ExtendedAttribute;
